...
Feature: Edit accesses
  ...
  Scenario: Edit an access
    ...
    And I send a "PUT" request to "/accesses/7fe88e83-5fdb-4487-bb78-caa897e6911f" with body:
    """
    {
  ...
  Scenario: Edit an access's read-only properties
    ...
    And the JSON node "uuid" should be equal to the string "7fe88e83-5fdb-4487-bb78-caa897e6911f"
